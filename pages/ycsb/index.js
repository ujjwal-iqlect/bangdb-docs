          ...
          <div className="article-content">
            <article className="article">
              ...
              <div className="article-body">
                ...
                <p>
                  YCSB provides a framework along with several workloads that
                  could be run to evaluate the performance and throughput of the
                  database in respective different scenarios. See{" "}
                  <Link
                    className="external"
                    href={
                ...
                <p>
                  Load stage is to load the data and then run stage is where we
                  run the test.
                </p>
                <p>
                  This section, we will go through how to set up the YCSB test
                  bench on your machine and then look into the results of the
                  test as compared with other databases like (MongoDB,
                  Couchbase, YugabyteDB and Redis) vis a vis BangDB.
                </p>
                ...
                />
                <h2>
                  Checkout getting started section or github to install the
                  BangDB
                </h2>
                <h3>Step 2</h3>
                <p>
