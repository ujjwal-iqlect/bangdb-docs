            ...
            <article className="article">
              ...
              <div className="article-body">
                ...
                <p>
                  ...
                  almost 95% or more data used to come from traditional sources,
                  mostly created by humans. These data used to move with defined
                  and predictable relatively slow speed. Majority of the data
                  were text data and largely structured. Use cases required the
                  actions resulting from the data in the form of reports,
                  dashboards or something which were not hyper real-time in
                  nature.
                </p>
                ...
                <p>
                  ...
                  kinds of data coming from non-traditional sources. Machine is
                  creating way more data than humans can create. All sorts of
                  devices, log files, machines etc. are now streaming data from
                  different disparate sources. These data have less defined
                  structure and they come in all sorts of sizes and shapes yet,
                  they are connected in some sense. These are real-time data
                  where value is perishable if not extracted and analyzed in
                ...
                <p>
                  While the trend is disruptive and happening with unprecedented
                  speed and putting lots of pressure on the organizations,
                  users, and developers to meet the requirements for their use
                  cases, on the other hand, majority of the databases and
                  systems in the market were created decades ago. This is
                  creating an ever-increasing impedance mismatch which cannot be
                  addressed using the older or existing traditional approach.
                </p>

                <h2>Use Cases</h2>
                <p>
                  IOT analysis - Edge | devices| servers | sensors | CEP |
                  monitoring text + video + audio - Hybrid data ingestion,
                  store, find and analyze. Realtime streaming data analysis -
                  forecast | predict | anomaly | continuous. Consumer Internet -
                  personalization | lead score | conversions | recommendation
                  Fintech - local and distributed fraud analysis, real-time
                  monitoring, recommendations Vehicle sensor - device data
                  analysis for predictive & personalized service Root cause -
                  Semantic, linked, graph, network data. Auto ML/AI - learning
                  and processing streaming data | auto train, deploy, manage.
                </p>

                <h2>Characteristics of the emerging data</h2>
                <p>
                  It&apos;s largely unstructured data. This is reflected in the
                  growth rate of database which deals with unstructured data.
                </p>
                <ul>
                  <li>
                ...
                />
                <p>Huge bandwidth, lower latency, and high penetration.</p>
                ...
                />
                <p>
                  IOT sensors cost is decreasing fast - 50% in 5 years average.
                </p>

                <h2>What&apos;s the major change?</h2>

                <p>
                  Modern apps require fusion of different systems to process the
                  data even for the traditional use cases. Which means we need
                  to bring is all kinds of tools and tech, stitch them and then
                  solve our problem in some way.
                </p>
                ...
                <p>
                  ...
                  data, but other elements are needed to be brought in as well.
                </p>

                <h2>What&apos;s the major challenge?</h2>

                <p>
                  Due to the need to handle many kinds of data at once to enable
                  use cases, the developers and organizations are feeling
                  compelled to bring in multiple different databases to create a
                  required system.
                </p>
                ...
                <ul>
                  ...
                  <p>
                    ...
                    together and creating a platform by stitching them together
                    is on the developer or the organizations.
                  </p>
                  <li>
                  ...
                  <p>
                    ...
                    create our solutions on top of it, which may keep demanding
                    more features and support as we move forward. Further,
                    scaling, distributing, deploying in hybrid mode and several
                    other dev-ops items would also need to be considered.
                  </p>
                  ...
                  <p>
                    Security of such system in enterprise environment is another
                    big effort as we will need to somehow manage security
                    homogeneity across these heterogenous systems.
                  </p>

                  <li>
                    Heavy and brittle application, shipping time keeps going up
                    to a frustrating level.
                  </li>
                  <p>
                    Finally, it will be up to the application to provide the
                    join, linking and correlation for data sitting in different
                    systems which makes the application so rigid that it becomes
                    almost impossible for organization and team to add new
                    features in time for their clients and customers. Therefore,
                    creating such system is not a prudent idea and hence this
                    creates an opportunity as well for us to come in and fill
                    the space.
                  </p>
                  <p>
                    Let&apos;s look at this bit more in detail and understand
                    the issues that we can get into if we go with the approach
                    of stitching existing different systems to implement the use
                    cases.
                  </p>
                </ul>
                ...
                <div className="flex">
                  <ul>
                    ...
                    <li>Adding a server is hard, costly, time consuming.</li>
                  </ul>
                ...
                <p>
                  ...
                  support required for dealing with scale and performance. Such
                  as overflow to disk with performance within the reasonable
                  bound. True concurrency to leverage the machine resources well
                  for high performance required for some of the use cases in
                  real-time.
                </p>
                ...
                <ol style={{ listStyleType: "upper-alpha" }}>
                          ...
                          <tr>
                            <td width={"70%"}>
                              <ul>
                                ...
                                <li>
                                  Need to find patterns & anomalies on streaming
                                  data
                                </li>
                                <li>
                  ...
                  <li>
                    ...
                    seems bit more obvious as how do we force a triple (subject,
                    object, and predicate) to be stored withing document store
                    with structure preserved for efficient queries and future
                    tasks. Further, graph database can use AI well in largely
                    implicit manner due to its natural layout, if properly
                    preserved.
                    <div className="table-container">
                      <table>
                        <tbody>
                          <tr>
                            <td width={"70%"}>
                              <ul>
                                ...
                                <li>
                                  Leveraging the relations for queries over the
                                  network
                                </li>
                                <li>
                                  Storing nodes and triples (subject, object,
                                ...
                                <li>Avoiding run-time relation-based joins</li>
                              </ul>
                            </td>
                  ...
                  <li>
                    Document database doesn&apos;t have AI right where data is.
                    Which means we need to export data to a AI layer, deal with
                    ML ops, train model and then import the model back into the
                    system or use it at application level. This is clearly not
                    scalable model. Also, it makes several jobs inefficient or
                    time taking, error prone for constant and continual update
                    of ML models.
                    <div className="table-container">
                      <table>
                        <tbody>
                          <tr>
                            <td width={"70%"}>
                              <ul>
                                <li>
                                  It remains largely manual task to train models
                                  [ even when metadata is largely fixed ]
                                </li>
                                <li>
